###########################################################################
## Makefile generated for Simulink model 'task1_model'. 
## 
## Makefile     : task1_model.mk
## Generated on : Wed Apr 28 15:33:54 2021
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/task1_model.elf
...
PRODUCT_NAME              = task1_model
MAKEFILE                  = task1_model.mk
MATLAB_ROOT               = /Applications/MATLAB_R2019b.app
MATLAB_BIN                = /Applications/MATLAB_R2019b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/adityaaaap/Desktop/RMIT\ Master\ of\ Mechatronics\ and\ Robotics\ Engineering/sem-2-mc256/EEET1368/Part7&8/src
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/task1_model.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/shared/svd/include -I$(START_DIR)/task1_model_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -I/Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/include -I/Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I/Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I/Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_STANDARD = -DMODEL=task1_model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/task1_model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/task1_model_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/task1_model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_PWM.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/MW_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ArduinoPinHandleMap.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_AnalogInput.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/MW_AnalogInput.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/task1_model_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


task1_model.o : $(START_DIR)/task1_model_ert_rtw/task1_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


task1_model_data.o : $(START_DIR)/task1_model_ert_rtw/task1_model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
MW_ArduinoHWInit.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


io_wrappers.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduinoAVRScheduler.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ext_svr_daemon.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtiostream_serial_daemon.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


daemon_checksum.o : /Users/adityaaaap/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) -o "$@" "$<"
