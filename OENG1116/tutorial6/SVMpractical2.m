...
x = x' ;
t = t' ;
Mdl = fitrsvm(x,t,'KernelFunction','polynomial','polynomialorder',7,'Standardize',true);
...
mdl = fitrsvm(x,t, 'KernelFunction', 'polynomial', ...
    'polynomialorder',4,'Standardize', true); %To standardize the data 
...
fprintf("MSE_Training = %f\n",MSE_training);
fprintf("RMSE_training = %f\n",RMSE_training);
toc
%%
clear;
clc;
